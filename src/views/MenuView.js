export class MenuView {
    ...
    createMapsMenu() {
        ...
        this.#imgMapOne.classList.add("selected", "mapOne", "maps");
        ...
        buttonNext.textContent = "JOUER";
        buttonNext.classList.add('play-button')
        ...
        this.#containerElement.append(titleSelectMap, presentationMap);
    }
}
